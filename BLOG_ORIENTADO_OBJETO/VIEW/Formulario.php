...
<h2>Nueva entradas </h2>
<form action="../CONTROLLER/Transaciones.php" method="post" enctype="multipart/form-data" name="form1">
<table >
<tr>
  <td>Títulos: 
  ...
  <tr>
    ...
    <input type="reset" name="btn_borrar" id="btn_reset" value="borrar">
  </td>
    </tr>
  <tr><td colspan="2" align="center"><a href="mostrar_Blog_DB.php">Página de visualización del blog</a></td></tr>
